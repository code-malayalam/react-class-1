  ...
  return (
    <footer>
      <section className="top-footer">
        <div className="total-container-top">
          <h2>What is Etsy?</h2>
          <p className="story">Read our wonderfully weird story</p>
      ...
      <section className="middle-footer">
        <div className="total-middle-footer">
          <p>
      ...
      <section className=" middle-footer-second">
        <div className="esty-aim">
          <svg
          ...
          <span>Esty is powered by 100% renewable electricity.</span>
        </div>
      </section>
      <section className="middle-footer-third">
        <div className="total-middle-third-footer">
          <div className="total-about">
            <div className="sub-items-one">
              <div
            ...
            <div className="social-logos">
              ...
              >
                ...
                <path
                  ...
                  fill="#FFFFFF"
                ></path>
                <circle cx="16.27" cy="7.735" r="0.96" fill="#FFFFFF"></circle>
              </svg>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
      ...
      <section className="footer-last">
        <div className="last-footer-places">
          <div className="totalplaces">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              aria-hidden="true"
