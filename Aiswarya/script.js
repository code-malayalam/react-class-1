...
fetch(
  "https://raw.githubusercontent.com/aiswaryaasudhakaran/training-project/main/etsy/discover.json"
)
  .then((response) => response.json())
  .then((data) => {
    renderDiscover(data);
...
fetch(
  "https://raw.githubusercontent.com/aiswaryaasudhakaran/training-project/main/etsy/deals.json"
)
  .then((response) => response.json())
  .then((data) => {
...
fetch(
  "https://raw.githubusercontent.com/aiswaryaasudhakaran/training-project/main/etsy/gift.json"
)
  .then((response) => response.json())
  .then((data) => {
...
fetch(
  "https://raw.githubusercontent.com/aiswaryaasudhakaran/training-project/main/etsy/add.json"
)
  .then((response) => response.json())
  .then((data) => {
    renderAddItems(data);
