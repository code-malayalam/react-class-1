...
import "./Powered.css";
import poweredLogo from "./poweredLogo.svg";

function Powered() {
  return (
    <div className="powered_container">
      <div className="powered_bg_start">
        <svg
      ...
      <div className="powered_content">
        <div className="powered_img">
          <img src={poweredLogo} />
        </div>
        <div className="powered_text">
          <p>Etsy is powered by 100% renewable electricity.</p>
        </div>

        <div className="powered_hover_text">
          <p>
            Etsy’s 100% renewable electricity commitment includes the
            electricity used by the data centres that host Etsy.com, the Sell on
            Etsy app, and the Etsy app, as well as the electricity that powers
            Etsy’s global offices and employees working remotely from home in
            the US.
          </p>
        </div>
      </div>
